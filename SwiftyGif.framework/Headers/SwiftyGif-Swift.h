...
SWIFT_MODULE_NAMESPACE_PUSH("SwiftyGif")
...
@interface UIImage (SWIFT_EXTENSION(SwiftyGif))
...
@interface UIImageView (SWIFT_EXTENSION(SwiftyGif))
...
- (NSInteger)currentFrameIndex SWIFT_WARN_UNUSED_RESULT;
/// Get frame at specifi index
- (UIImage * _Nonnull)frameAtIndexWithIndex:(NSInteger)index SWIFT_WARN_UNUSED_RESULT;
/// Check if the imageView has been discarded and is not in the view hierarchy anymore.
///
/// returns:
/// A boolean for weather the imageView was discarded
- (BOOL)isDiscarded:(UIView * _Nullable)imageView SWIFT_WARN_UNUSED_RESULT;
/// Check if the imageView is displayed.
///
/// returns:
/// A boolean for weather the imageView is displayed
- (BOOL)isDisplayedInScreen:(UIView * _Nullable)imageView SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, strong) UIImage * _Nullable gifImage;
